...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-bicep";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests only — integration tests need `bicep` and `az` on PATH.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.Bicep.Tests" / "Tamp.Bicep.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.Bicep" / "Tamp.Bicep.csproj");
